    ...
    public function loadInfo(Request $request)
    {
        ...
        if ( $request->get('negTipo') == 'persona') {
            ...
            $request->validate([
                ...
                'telefono' => 'nullable|string|min:8|max:19',
                'imagen_perfil_src' => 'nullable|image|mimes:png,jpg,jpeg|size:2048|dimensions:min_width=150,min_height=150,max_width=250,max_height=250',
        ...
        switch ($municipio) {
            ...
            case 'sslC1':
                ...
                break;
            case 'sslC2':
                $municipio = 'San Salvador Centro/Mejicanos</option>';
                break;
            case 'sslC3':
