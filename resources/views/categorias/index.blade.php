...
@section('title', 'Categorias')
    ...
    <div class="card mb-3" style="border: ridge 1px #ff1620;">
        ...
        <div class="card-body position-relative mt-4">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="text-center">🗂️ Categorías de Productos 🗂️</h1>
    ...
    {{-- Tabla de categorias --}}
    <div class="mb-3">
        <a href="{{ route('categorias.create') }}"><button class="btn btn-primary me-1 mb-1" type="button"><i class="fas fa-plus"></i> Agregar nueva categoría</button></a>
    </div>
        ...
        <div class="card-header">
            <div class="row flex-between-end">
                ...
                <div class="col-auto align-self-center">
                    <h5 class="mb-0" data-anchor="data-anchor">Tabla de categorías</h5>
                </div>
                --}}
            </div>
        </div>
