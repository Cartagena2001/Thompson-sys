                ...
                <form method="POST" action="{{ route('users.store') }}" role="form" enctype="multipart/form-data">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-6">
                            ...
                            <input class="form-control" type="text" name="whatsapp" id="whatsapp" data-intl-tel-input-id="0" autocomplete="off" value="{{ old('whatsapp', request()->input('whatsapp'))}}" placeholder="0000-0000" minlength="8" maxlength="21">
                            @error('whatsapp')
                                <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row mb-2"> 
                        ...
                        <div class="col-6">
                            ...
                            <input class="form-control" type="tel" name="telefono" id="telefono" data-intl-tel-input-id="1" autocomplete="off" value="{{ old('telefono', request()->input('telefono'))}}" placeholder="0000-0000" minlength="8" maxlength="21">
                            @error('telefono')
                                <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-12 col-sm-4 offset-sm-4">
                        ...
                        <div class="input-group mb-4">
                            ...
                            <input id="password" type="password" name="password" class="form-control" value="{{ old('password', request()->input('password'))}}" maxlength="12" autocomplete="off" required>
                        ...
                        <div class="input-group mb-4">
                            ...
                            <input class="form-control" type="password" name="password_confirmation" id="password_confirmation" value="{{ old('password_confirmation', request()->input('password_confirmation'))}}" maxlength="12" autocomplete="off" required>
