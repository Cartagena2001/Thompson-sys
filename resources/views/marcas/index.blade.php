...
@section('title', 'Marcas')
    ...
    <div class="row g-3 mb-3">
        ...
        <div class="col-sm-6 col-md-4">
            <div class="card overflow-hidden" style="min-width: 12rem">
                ...
                <!--/.bg-holder-->
                <div class="card-body position-relative">
                    <h6># Marcas Inactivas</h6>
                    <div class="display-4 fs-4 mb-2 fw-normal font-sans-serif text-warning" data-countup='{"endValue":58.386,"decimalPlaces":2,"suffix":"k"}'>
                        <?php 
                        $marcasI = DB::table('marca')
    ...
    {{-- Tabla de categorias --}}
    <div class="mb-3">
        <a href="{{ route('marcas.create') }}"><button class="btn btn-primary me-1 mb-1" type="button"><i class="fas fa-plus"></i> Agregar nueva marca</button></a>
    </div>
