...
<script>
  ...
  $.ajax({
    url: '/api/getWeeklySales', // Ruta correcta para el nuevo endpoint
    type: 'GET',
    dataType: 'json',
    success: function (response) {
      ...
      am4core.ready(function () {
        ...
        var chart = am4core.create('chart_ventas_semanales', am4charts.XYChart); // Cambiar el tipo de gráfico a XYChart
        chart.data = result.ventas_semanales; // Cambiar el nombre del campo de datos

        // Eje X
        var categoryAxis = chart.xAxes.push(new am4charts.CategoryAxis());
        categoryAxis.dataFields.category = 'fecha'; // Cambiar el nombre del campo de categoría
        ...
        series.dataFields.valueY = 'total_ventas_dia'; // Cambiar el nombre del campo de valores
        series.dataFields.categoryX = 'fecha'; // Cambiar el nombre del campo de categoría
...
function getSalesByDayChart() {
  $.ajax({
    url: '/api/getSalesByDay', // Ruta correcta para el nuevo endpoint
    type: 'GET',
    dataType: 'json',
    success: function (response) {
      let result = JSON.parse(JSON.stringify(response));
