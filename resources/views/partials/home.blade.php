      ...
      <!-- ============================================-->
      <!-- <section> begin ============================-->
      <section class="light" id="contactsection">

        <div class="bg-holder overlay" style="background-image:url({{ URL('assets/img/bg/contact-forn-bg.png') }} );background-position: center top;">
        </div>
        <!--/.bg-holder-->
